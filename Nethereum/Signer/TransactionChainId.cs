...
namespace Nethereum.Signer
{
    ...
    {  
        ...
        public byte[] ChainId { get { return SimpleRlpSigner.Data[6];}}

        public byte[] RHash { get { return SimpleRlpSigner.Data[7];}}

        public byte[] SHash { get { return SimpleRlpSigner.Data[8];}}

        /// <summary>
        /// Recovered Key from Signature
        /// </summary>
        public override EthECKey Key { get { return EthECKey.RecoverFromSignature(SimpleRlpSigner.Signature,
