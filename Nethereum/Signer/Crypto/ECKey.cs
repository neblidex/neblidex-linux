...
namespace Nethereum.Signer.Crypto
{
    ...
    public class ECKey
    {
        ...
        internal static readonly ECDomainParameters CURVE;
        ...
        internal ECPrivateKeyParameters PrivateKey { get { return _Key as ECPrivateKeyParameters;}}


        internal static X9ECParameters Secp256k1 { get { return _Secp256k1;}}
        ...
        public static ECKey RecoverFromSignature(int recId, ECDSASignature sig, byte[] message, bool compressed)
        {
            ...
            var prime = new BigInteger(1,
                NBitcoin.BouncyCastle.Utilities.Encoders.Hex.Decode(
