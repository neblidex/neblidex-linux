...
namespace Nethereum.Signer
{
    public class EthECDSASignature
    {
        ...
        internal ECDSASignature ECDSASignature { get; set; }

        public byte[] R { get { return ECDSASignature.R.ToByteArrayUnsigned();} }

        public byte[] S { get { return ECDSASignature.S.ToByteArrayUnsigned();} }
        ...
        public bool IsLowS { get { return ECDSASignature.IsLowS;}}
