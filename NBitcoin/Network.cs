...
namespace NBitcoin
{
	...
	public class Network
	{
		...
		public bool useGroestlHash = false;
		...
		static Network()
		{
			...
			if(App.testnet_mode == true){
				//For some reason we have to load both Main and Testnet
		...
		private static Network _SegNet = null;
